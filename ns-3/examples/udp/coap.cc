...
// - DropTail queues 
// - Tracing of queues and packet receptions to file "coap.tr"
...
//
#if 0
  LogComponentEnable ("CoapExample", LOG_LEVEL_INFO);
...
//
// Create a CoapClient application to send UDP datagrams from node zero to
// node one.
//
...
//
  ...
  csma.EnableAsciiAll (ascii.CreateFileStream ("coap.tr"));
  csma.EnablePcapAll ("coap", false);
