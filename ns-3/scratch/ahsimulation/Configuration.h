...
struct Configuration {
	...
	uint32_t nControlLoops = 256/2;
	uint32_t coapPayloadSize = 64;
	uint32_t BeaconInterval = 599040/2; //102400 25600 us
	uint32_t trafficInterval = 25000; //ms 55,110,210,310,410,515,615,720,820,950,1024 beacon interval *4
	...
	uint32_t Nsta = 256; //1 ----- 10,50,100,200,500,1000,10000
	int NRawSta = -1; //-1
	int SlotFormat = -1; //0;
